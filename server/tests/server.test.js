...
describe('GET /todos/:id', () => {
   ...
   it('should not return a todo doc creator by other user', (done) => {
      request(app)
...
describe('/DELETE /todos/:id', () => {
   ...
   it('should not delete ', (done) => {
      const delHexID = todos[0]._id.toHexString();
...
describe('POST /users', () => {
   ...
   it('should not create a user if email in use', (done) => {
      const email = users[0].email; // Referencing Seed data email
      const password = 'testPassword';
...
describe('POST /users/login', () => {
   ...
   it('should reject login with invalid credentials', (done) => {
      request(app)
         .post('/users/login')
         .send({email: users[1].email, password: 'someWrongPw'})
         .expect(400)
         .expect((res) => {
